...
export default function ExpensePieChart({ data }: Props) {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-700">
      <div className="mb-4">
        <h3 className="text-base font-bold text-slate-800 dark:text-white">Expense Breakdown</h3>
        <p className="text-xs text-slate-400 mt-0.5">By category this month</p>
      </div>
      {data.length === 0 ? (
